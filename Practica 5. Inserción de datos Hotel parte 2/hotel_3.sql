...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:16:46
...
(1, 2, 2, '2026-01-29', 'Se realizó check-in sin inconvenientes'),
(2, 4, 5, '2026-02-13', 'El huésped solicitó toallas adicionales'),
(3, 6, 1, '2025-12-31', 'Se reportó falla en el aire acondicionado'),
(4, 8, 1, '2026-02-06', 'Se solicitó limpieza del cuarto'),
(5, 9, 3, '2026-02-25', 'Se quejó de un platillo');
...
(1, 1, '2026-02-01', 6685, 'Efectivo', 'EF-HTL-0001', 'Pagado'),
(2, 3, '2026-02-02', 2400, 'deposito', 'DEP-HTL-0001', 'Cancelado'),
(3, 5, '2026-02-21', 3300, 'tarjeta débito', 'TAR-DEB-0001', 'Pendiente'),
(4, 7, '2026-02-14', 1300, 'Cheque', 'CHE-HTL-0001', 'Cancelado'),
(5, 10, '2026-02-11', 1337, 'tarjeta débito', 'TAR-DEB-0002', 'Pagado');
...
(1, 'Room Service', 150),
(2, 'Lavandería', 45),
(3, 'Desayuno buffet', 180),
(4, 'Estacionamiento privado (por noche)', 80),
(5, 'Spa básico', 400);
